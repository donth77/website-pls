  ...
  return (
    <div className="flex min-h-dvh items-center justify-center bg-white px-6 dark:bg-zinc-950">
      <div className="w-full max-w-sm">
        ...
        {emailSent ? (
          <div className="rounded-lg border border-green-200 bg-green-50 px-4 py-6 text-center dark:border-green-800 dark:bg-green-950">
            <Mail className="mx-auto mb-3 h-8 w-8 text-green-600 dark:text-green-400" />
            ...
            <form onSubmit={handleEmailSignIn} className="mb-4">
              ...
              <div className="flex gap-2">
                <input
                  ...
                  required
                  className="flex-1 rounded-lg border border-zinc-200 bg-white px-3 py-2 text-sm transition outline-none placeholder:text-zinc-400 focus:border-zinc-400 focus:ring-1 focus:ring-zinc-400 dark:border-zinc-700 dark:bg-zinc-900 dark:placeholder:text-zinc-500 dark:focus:border-zinc-500 dark:focus:ring-zinc-500"
                />
                <Button
                  type="submit"
                  disabled={isLoading || !email.trim()}
                  className="rounded-lg bg-zinc-900 px-4 py-2 text-sm font-medium text-white shadow-sm transition hover:bg-zinc-800 aria-disabled:opacity-50 dark:bg-zinc-100 dark:text-zinc-900 dark:hover:bg-zinc-200"
                >
